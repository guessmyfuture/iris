...
import com.adient.iris.domain.Authority;
import com.adient.iris.domain.User;
import com.adient.iris.repository.AuthorityRepository;
...
import com.adient.iris.web.rest.errors.ExceptionTranslator;
import com.adient.iris.web.rest.vm.KeyAndPasswordVM;
import com.adient.iris.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = IrisApp.class)
