package com.adient.iris.repository;

import com.adient.iris.IrisApp;
import com.adient.iris.config.Constants;
import com.adient.iris.config.audit.AuditEventConverter;
import com.adient.iris.domain.PersistentAuditEvent;
...
import static com.adient.iris.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
